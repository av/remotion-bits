...
The `Particles` system allows you to create complex particle effects using `Spawner` to emit particles and `Behavior` to control their physics and properties over time.
