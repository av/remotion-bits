...
description: Animate text content with splitting capabilities.
---

The `TextTransition` component specializes in animating text, allowing you to split text by characters, words, or lines, and animate them individually with staggering.
...
Inherits all properties from [MotionTransition Configuration](/docs/reference/motion-transition#motion-configuration) (transforms, visual, timing), plus:
